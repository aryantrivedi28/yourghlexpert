...
export function PricingSection() {
  ...
  const plans = [
    {
      ...
      featured: false,
      ctaText: 'Get Started →',
      ctaAction: 'contact' // goes to contact page
    },
    {
      ...
      featured: true,
      ctaText: 'Book a Call →',
      ctaAction: 'booking' // opens booking modal
    },
    {
  ...
  const handleCTAClick = (action: string) => {
    ...
    // For 'contact' action, the link will handle navigation naturally
  }
